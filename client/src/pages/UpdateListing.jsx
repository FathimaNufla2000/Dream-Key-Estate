    ...
    <main className='p-3 max-w-4xl mx-auto font-serif'>
      ...
      <div className="flex flex-col gap-4 flex-1 ">
        ...
        <div className='flex gap-4'>
          <input onChange={(e)=> setFiles(e.target.files)} className='p-3 border border-cyan-500 bg-cyan-100 rounded w-full' 
          type='file' 
          id='images' 
          accept='image/*' 
          multiple />
          <button type='button'
          disabled={uploading} 
          onClick={handleImageSubmit} className='p-3  text-green-700 border border-cyan-500 
          ...
          formData.imageUrls.map((url, index) => (
            ...
            className="flex justify-between p-3 border border-cyan-500 items-center">
              ...
              className=' text-red-700 p-3 rounded-lg uppercase 
                 hover:opacity-75 font-bold'>Delete</button>
            </div>
          ))
          }
