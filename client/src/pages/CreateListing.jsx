      ...
      <input type='text' 
        ...
        <div className='flex gap-6 flex-wrap '>
          ...
          <div className='flex gap-2'>
            ...
            className='w-5'
            onChange={handleChange} 
            checked={formData.parking}></input>
          ...
          <div className='flex gap-2'>
            ...
            className='w-5'
            onChange={handleChange} 
            checked={formData.furnished}></input>
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {formData.type === 'rent' && (
            <span className='text-cyan-700 font-bold text-xs'>(Rs. / Month)</span>  
           )}
            </div>
          </div>
      ...
      <div className="flex flex-col gap-4 flex-1 ">
        ...
        <div className='flex gap-4'>
          ...
          onChange={(e)=> 
            ...
            className='p-3 border border-cyan-500 bg-cyan-100 rounded w-full' 
          type='file' 
          id='images' 
          accept='image/*' 
          multiple 
          ...
          className='p-3  text-green-700 border border-cyan-500 
          font-semibold bg-cyan-100 rounded uppercase hover:shadow-lg disabled:opacity-80'>
